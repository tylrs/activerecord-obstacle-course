...
# ----------------------
  ...
  it '21. calculates the total sales' do
    ...
    # ------------------ Using ActiveRecord ---------------------
    # Solution goes here
    total_sales = Order.all.sum("amount")
    # -----------------------------------------------------------
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    orders = Order.where(id: OrderItem.where(item_id: @item_4.id).pluck(:order_id))
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    #  Solution goes here
    #  Grab all 
    orders = Order.where(user: @user_2, id: OrderItem.where(item_id: @item_4.id).pluck(:order_id))
    # -----------------------------------------------------------
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    # Solution goes here
    ordered_items = Item.where(id: OrderItem.all.distinct.pluck(:item_id))
    # ---------------------------------------------------------------
